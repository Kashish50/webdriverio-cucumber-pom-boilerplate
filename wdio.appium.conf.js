...
const sourceSpecDirectory = `tests/features/featureFilesHealthECO`;
const jsonTmpDirectory = `tests/reports/json/tmp/`;


let featureFilePath = `${sourceSpecDirectory}/signUp.feature`;
...
exports.config = {
    ...
    capabilities: [{
        ...
        deviceName: 'SamsungM30S',
        app: "C:/Kashish_Data/APKFiles/Health_Eco_Alpha_base.apk",
        appPackage: "com.scb.healtheco.alpha",
        appActivity: "com.scb.healtheco.healtheco_app.MainActivity"
    }],
    //
    // ===================
    // Test Configurations
    ...
    cucumberOpts: {
        require: ['./tests/features/step_definitions_healthECO/*.js', './tests/features/support/*.js'],        // <string[]> (file/dir) require files before executing features
        ...
        tagExpression: '@Scenario1',      // <string> (expression) only execute the features or scenarios with tags matching the expression
