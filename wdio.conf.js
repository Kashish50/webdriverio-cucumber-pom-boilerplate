...
let featureFilePath = `${sourceSpecDirectory}/paytmHomePage.feature`;
...
exports.config = {
    ...
    capabilities: [{
        ...
        'goog:chromeOptions': {
            ...
            args: ['--incognito', '--disable-gpu', 'start-fullscreen'],
    ...
    cucumberOpts: {
        ...
        tagExpression: '@Scenario2',      // <string> (expression) only execute the features or scenarios with tags matching the expression
